...
export const acceptConnectionRequest = async (req, res) => {
	try {
		...
		// so i have to push my userId to your connection in your userModel and viceversa also true
...
export const removeConnection = async (req, res) => {
	try {
		...
		// if im not your friend then ur also not my friend ;)
		// so i have to pull my userId from your connection in your userModel and viceversa also true
